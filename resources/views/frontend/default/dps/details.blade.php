                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <div class="inputs">
                                                    ...
                                                    <div class="input-info-text min-max">{{ __("Minimum :minimum_amount and Maximum :maximum_amount",['minimum_amount' => $currencySymbol.$dps->plan->min_decrement_amount,'maximum_amount' => $currencySymbol.$dps->plan->max_decrement_amount ]) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
