            ...
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">
                        <a href="{{ route('user.pay.bill.history') }}" class="card-header-link"><i
                                data-lucide="credit-card"></i>{{ __('My Bill Payments') }}</a>
                    </div>
                </div>
                        ...
                        <form action="{{ route('user.pay.bill.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="inputs">
                                        <label for="" class="input-label">{{ __('Countries') }} <span
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="inputs">
                                        <label for="" class="input-label">{{ __('Services') }} <span
                                                class="required">*</span></label>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 custom-input-box d-none">

                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="inputs">
                                        <label for="" class="input-label">{{ __('Amount') }} <span
                                                class="required">*</span></label>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <button
                                        @if (auth()->user()->passcode !== null && setting('pay_bill_passcode_status')) type="button"
