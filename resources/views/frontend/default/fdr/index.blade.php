                                ...
                                <div class="plan-card-box">
                                    ...
                                    <div class="list">
                                        ...
                                        <div class="single">
                                            ...
                                            <div>{{ $plan->can_cancel ? ($plan->cancel_type == 'anytime' ? 'Anytime' : $plan->cancel_days.' Days') : __('No') }}</div>
                                        </div>
                                    ...
                                    <a href="#"
                                       ...
                                       data-cancel-charge="{{ $plan->cancel_fee_type == 'fixed' ? $plan->cancel_fee.' '.$currency : $plan->cancel_fee.'%' }}"
