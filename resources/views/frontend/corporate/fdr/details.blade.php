...
@section('content')
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links d-flex">
                        @if ($fdr->plan?->is_add_fund_fdr == 1 && $fdr->status == App\Enums\FdrStatus::Running)
                        ...
                        @endif
                        @if ($fdr->plan?->is_deduct_fund_fdr == 1 && $fdr->status == App\Enums\FdrStatus::Running)
                            <a href="javascript:void(0)" class="bg-danger card-header-link" data-bs-toggle="modal"
                                data-bs-target="#decrement">
                    ...
                    <div class="site-custom-table site-custom-table-sm">
                        <div class="contents">
                            ...
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold"><span
                                            class="type site-badge badge-primary">{{ $fdr->status }}</span></div>
                                </div>
                            </div>
                            <div class="site-table-list">
                                <div class="site-table-col">
                            ...
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold">{{ $fdr->profit() }} (Every {{ $fdr->plan->intervel }} Days)
                                    </div>
                                </div>
                            </div>
                            <div class="site-table-list">
                            ...
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold"><span
                                            class="type site-badge badge-primary">{{ $fdr->givenInstallemnt() ?? 0 }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold">
                                        @php
                                            $trx = \App\Models\FDRTransaction::where('fdr_id', $fdr->id)
                            ...
                            <div class="site-table-list">
                                ...
                                <div class="site-table-col">
                                    <div class="fw-bold">{{ $fdr->transactions->sum('given_amount') . ' ' . $currency }}
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="site-table-list">
                                        ...
                                        <div class="site-table-col">
                                            <div class="trx fw-bold">
                                                {{ \Carbon\Carbon::parse($trx->given_date)->format('M d Y') }}</div>
                                        </div>
                                        <div class="site-table-col">
                                        ...
                                        <div class="site-table-col">
                                            <div class="trx fw-bold">
                                                {{ $trx->paid_amount != null ? number_format($trx->paid_amount, 2) . ' ' . $currency : 'None' }}
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="step-details-form">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <div class="inputs">
                                                    <label for=""
                                                        class="input-label">{{ __('Enter Increase Amount:') }}<span
                                                            class="required">*</span></label>
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" name="increase_amount"
                                                            id="increase_amount" required>
                                                        <span class="input-group-text">{{ $currency }}</span>
                                                    </div>
                                                    <div class="input-info-text min-max">
                                                        {{ __('Minimum :min and Maximum :max', ['min' => $currencySymbol . $fdr->plan->min_increment_amount, 'max' => $currencySymbol . $fdr->plan->max_increment_amount]) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            {{-- FDR Decrement --}}
            <div class="modal fade" id="decrement" tabindex="-1" aria-labelledby="decrementModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-md modal-dialog-centered">
                    <div class="modal-content site-table-modal">
                        <div class="modal-body popup-body">
                                    ...
                                    <div class="step-details-form">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <div class="inputs">
                                                    <label for=""
                                                        class="input-label">{{ __('Enter Decrease Amount:') }}<span
                                                            class="required">*</span></label>
                                                    <div class="input-group">
                                                        <input type="number" min="1" class="form-control"
                                                            name="decrease_amount" value="">
                                                        <span class="input-group-text">{{ $currency }}</span>
                                                    </div>
                                                    <div class="input-info-text min-max">
                                                        {{ __('Minimum :minimum_amount and Maximum :maximum_amount', ['minimum_amount' => $currencySymbol . $fdr->plan->min_decrement_amount, 'maximum_amount' => $currencySymbol . $fdr->plan->max_decrement_amount]) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
