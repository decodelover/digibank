...
<div class="container-fluid">
    <div class="row justify-content-start">
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="site-card">
                <div class="site-card-header">
                    <h3 class="title">{{ __('Registration Page Settings') }}</h3>
                </div>
                <div class="site-card-body">
                    <form action="{{ route('admin.page.setting.update') }}" method="post"
                          enctype="multipart/form-data">
                        ...
                        <div class="addOptions">
                            @foreach (json_decode(getPageSetting('register_custom_fields'),true) ?: [] as $key => $value)
                            <div class="mb-4">
                                <div class="option-remove-row row">
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="site-input-groups">
                                            <input name="register_custom_fields[{{ $key }}][name]" class="box-input"
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="site-input-groups">
                                            <select name="register_custom_fields[{{ $key }}][type]"
                                    ...
                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="site-input-groups mb-0">
                                            <select name="register_custom_fields[{{ $key }}][validation]"
