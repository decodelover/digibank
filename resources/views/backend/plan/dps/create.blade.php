                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 schema-name">
                                        <div class="site-input-groups">
                                            ...
                                            <input type="number" id="total_installment" name="total_installment"
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="number" id="per_installment" name="per_installment"
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="number" step="0.01" id="interest_rate" name="interest_rate" step="0.01"
                                                    class="form-control" required />
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" id="total_deposit" name="total_deposit"
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" id="user_profit" name="user_profit"
                                                    class="form-control" readonly />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label" for="">
                                                {{ __('Total Mature Amount:') }}
                                            </label>
                                            <div class="input-group joint-input">
                                                <input type="text" id="total_mature_amount" name="total_mature_amount"
                                                    class="form-control" readonly />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="number" name="delay_days" class="form-control" required />
                                    ...
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="position-relative">
                                                <input type="number" class="box-input" step="0.01" name="charge"
                                                    required />
                                                <div class="prcntcurr">
                            ...
                            <div class="site-card-body">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label" for="">
                                                {{ __('Increase DPS Amount') }}
                                            </label>
                                            <div class="switch-field same-type">
                                                <input type="radio" id="radio-can-is_upgrade" name="is_upgrade"
                                                    checked="" value="1" />
                                                <label for="radio-can-is_upgrade">{{ __('Yes') }}</label>
                                                <input type="radio" id="radio-can-is_upgrade1" name="is_upgrade"
                                                    value="0" />
                                    ...
                                    <div class="col-xl-6" id="increase_type">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                <input type="radio" id="radio-unlimited" name="increment_type"
                                                    checked="" value="unlimited" />
                                                <label for="radio-unlimited">{{ __('Unlimited') }}</label>
                                                <input type="radio" id="radio-fixed" name="increment_type"
                                                    value="fixed" />
                                    ...
                                    <div class="col-xl-6" id="dps-max-increase-amount">
                                        <div class="site-input-groups">
                                            <label class="box-input-label" for="">
                                                {{ __('Max Increase Amount:') }}
                                            </label>
                                            <div class="input-group joint-input">
                                                <input type="number" name="max_increment" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6" id="dps-increase-charge">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="increment_fee" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                            ...
                            <div class="site-card-body">
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="site-input-groups">
                                            <label class="box-input-label" for="">
                                                {{ __('Decrease DPS Amount') }}
                                            </label>
                                            <div class="switch-field same-type">
                                                <input type="radio" id="radio-can-is_downgrade" name="is_downgrade"
                                                    checked="" value="1" />
                                                <label for="radio-can-is_downgrade">{{ __('Yes') }}</label>
                                                <input type="radio" id="radio-can-is_downgrade1" name="is_downgrade"
                                                    value="0" />
                                    ...
                                    <div class="col-xl-6" id="decrease_type">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                <input type="radio" id="radio-decrease-unlimited" name="decrement_type"
                                                    checked="" value="unlimited" />
                                                <label for="radio-decrease-unlimited">{{ __('Unlimited') }}</label>
                                                <input type="radio" id="radio-decrease-fixed" name="decrement_type"
                                                    value="fixed" />
                                    ...
                                    <div class="col-xl-6" id="dps-min-decrease-amount">
                                        <div class="site-input-groups">
                                            <label class="box-input-label" for="">
                                                {{ __('Min Decrease Amount:') }}
                                            </label>
                                            <div class="input-group joint-input">
                                                <input type="text" name="min_decrement" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6" id="dps-max-decrease-amount">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="max_decrement" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6" id="dps-decrease-charge">
                                        <div class="site-input-groups">
                                            ...
                                            <div class="input-group joint-input">
                                                <input type="text" name="decrement_fee" class="form-control" />
                                                <span
                                                    class="input-group-text">{{ setting('site_currency', 'global') }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="site-input-groups">
                                            ...
                                            <div class="switch-field same-type">
                                                <input type="radio" id="radio-five" name="status" checked=""
                                                    value="1" />
                                                <label for="radio-five">{{ __('Active') }}

                                                </label>
                                                <input type="radio" id="radio-six" name="status" value="0" />
                                                <label for="radio-six">{{ __('Deactivate') }}
