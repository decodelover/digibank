                            ...
                            <form action="{{ route('admin.plan.loan.store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="col-xl-12">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="text" name="name" class="box-input" placeholder="Plan name"
                                            value="{{ old('name') }}" />
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" name="per_installment" step="0.01"
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        <label class="box-input-label" for="">
                                            {{ __('Loan Processing Fee:') }}
                                        </label>
                                        <div class="position-relative">
                                            <input step="0.05" type="number" class="box-input" name="loan_fee" value="{{ old('loan_fee') }}">
                                            <div class="prcntcurr">
                                                <select name="loan_fee_type" class="form-select" id="">
                                ...
                                <div class="col-xl-12">
                                    <div class="site-input-groups fw-normal">
                                        <label for=""
                                            class="box-input-label">{{ __('Loan Instructions:') }}</label>
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            <input type="radio" id="radio-can-featured" name="featured" checked=""
                                                value="1" />
    ...
    <script>
        ...
        function addOptions(el, i) {
            ...
            var option = `<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 row" id="option-value-row">
                        ...
                        <div class="col-md-2" id="option-value-action">
                            <button class="add-option-row me-2" onclick="addOptionValue('option-fields` + i + `','` +
                i + `')" type="button">
