                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="title-content">
                            ...
                            <a href="{{ url()->previous() }}" class="title-btn">
                            ...
                            <form action="{{route('admin.plan.loan.update',$plan->id)}}" method="post"
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="text" name="per_installment" step="0.01" class="form-control" value="{{ $plan->per_installment }}" required/>
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="position-relative">
                                            <input step="0.05" type="number" class="box-input" name="loan_fee" value="{{ old('loan_fee',$plan->loan_fee) }}">
                                            <div class="prcntcurr">
                                                <select name="loan_fee_type" class="form-select" id="">
                                                    <option @selected($plan->loan_fee_type == 'percentage') value="percentage">
                                                        %
                                                    </option>
                                                    <option @selected($plan->loan_fee_type == 'fixed') value="fixed">
                                                        {{ $currencySymbol }}
                                                    </option>
                                                </select>
                                            </div>
