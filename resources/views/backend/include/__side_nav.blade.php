        ...
        <ul class="side-nav-menu">
            ...
            ********************************************************* --}}
            @canany(['transaction-list', 'user-paybacks-list', 'bank-profit'])
                ...
                @endcan
                @canany(['user-paybacks-list', 'bank-profit'])
                    <li class="side-nav-item side-nav-dropdown {{ isActive(['admin.paybacks', 'admin.bank.profit']) }}">
                        ...
                        <ul class="dropdown-items">
                            @can('user-paybacks-list')
                                <li class="{{ isActive('admin.paybacks') }}">
                                    <a href="{{ route('admin.paybacks') }}"><i
                                            data-lucide="credit-card"></i><span>{{ __('User Paybacks') }}</span></a>
                                </li>
                            @endcan
                            @can('bank-profit')
                ...
                @canany(['pending-transfers', 'rejected-transfers', 'all-transfers', 'allied-transfers',
                    'others-bank-transfers', 'wire-transfer', 'others-bank-list'])
                    <li
                            ...
                            @can('others-bank-list')
                                <li class="side-nav-item {{ isActive('admin.others-bank*') }}">
                                    <a href="{{ route('admin.others-bank.index') }}"><i
                                            data-lucide="landmark"></i><span>{{ __('Others Bank') }}</span></a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                ...
                {{-- ************************************************************* DPS
            ********************************************************* --}}
                @canany(['dps-plan-list', 'dps-plan-create', 'dps-plan-edit', 'ongoing-dps', 'payable-dps', 'complete-dps',
                    'closed-dps', 'all-dps'])
                    <li class="side-nav-item side-nav-dropdown {{ isActive(['admin.dps*', 'admin.plan.dps*']) }}">
                        <a href="javascript:void(0);" class="dropdown-link"><i
                                data-lucide="archive"></i><span>{{ __('DPS') }}</span>
                            <span class="right-arrow"><i data-lucide="chevron-down"></i></span>
                        </a>
                        ...
                        <ul class="dropdown-items">
                            @can('ongoing-dps')
                                <li class="side-nav-item {{ isActive('admin.dps.ongoing*') }}">
                                    <a href="{{ route('admin.dps.ongoing') }}"><i
                                            data-lucide="user-check"></i><span>{{ __('Ongoing DPS') }}</span></a>
                                </li>
                            @endcan
                            @can('payable-dps')
                                <li class="side-nav-item {{ isActive('admin.dps.payable*') }}">
                                    <a href="{{ route('admin.dps.payable') }}"><i
                                            data-lucide="user-check"></i><span>{{ __('Payable DPS') }}</span></a>
                                </li>
                            @endcan
                            @can('complete-dps')
                                <li class="side-nav-item {{ isActive('admin.dps.complete*') }}">
                                    <a href="{{ route('admin.dps.complete') }}"><i
                                            data-lucide="user-check"></i><span>{{ __('Completed DPS') }}</span></a>
                                </li>
                            @endcan
                            @can('closed-dps')
                                <li class="side-nav-item {{ isActive('admin.dps.close*') }}">
                                    <a href="{{ route('admin.dps.close') }}"><i
                                            data-lucide="user-check"></i><span>{{ __('Closed DPS') }}</span></a>
                                </li>
                            @endcan
                            @can('all-dps')
                                <li class="side-nav-item {{ isActive('admin.dps.all*') }}">
                                    <a href="{{ route('admin.dps.all') }}"><i
                                            data-lucide="user-check"></i><span>{{ __('All DPS') }}</span></a>
                                </li>
                            @endcan
                            @canany(['dps-plan-list', 'dps-plan-create', 'dps-plan-edit'])
                                <li class="side-nav-item {{ isActive('admin.plan.dps*') }}">
                                    <a href="{{ route('admin.plan.dps.index') }}"><i
                                            data-lucide="airplay"></i><span>{{ __('DPS Plans') }}</span></a>
                                </li>
                            @endcanany
                        </ul>
                    </li>
                ...
                {{-- ************************************************************* FDR
            ********************************************************* --}}
                @canany(['fdr-plan-list', 'fdr-plan-create', 'fdr-plan-edit', 'ongoing-fdr', 'closed-fdr', 'completed-fdr',
                    'all-fdr'])
                    <li class="side-nav-item side-nav-dropdown {{ isActive(['admin.fdr*', 'admin.plan.fdr*']) }}">
                        <a href="javascript:void(0);" class="dropdown-link"><i
                                data-lucide="book"></i><span>{{ __('FDR') }}</span>
                            <span class="right-arrow"><i data-lucide="chevron-down"></i></span></a>
                        <ul class="dropdown-items">
                            @can('ongoing-fdr')
                                <li class="side-nav-item {{ isActive('admin.fdr.ongoing*') }}">
                                    <a href="{{ route('admin.fdr.ongoing') }}"><i
                                            data-lucide="user-check"></i><span>{{ __('Ongoing FDR') }}</span></a>
                                </li>
                            @endcan
                            @can('closed-fdr')
                                <li class="side-nav-item {{ isActive('admin.fdr.close*') }}">
                                    <a href="{{ route('admin.fdr.close') }}"><i
                                            data-lucide="user-check"></i><span>{{ __('Closed FDR') }}</span></a>
                                </li>
                            @endcan
                            @can('completed-fdr')
                                <li class="side-nav-item {{ isActive('admin.fdr.completed*') }}">
                                    <a href="{{ route('admin.fdr.completed') }}"><i
                                            data-lucide="user-check"></i><span>{{ __('Completed FDR') }}</span></a>
                                </li>
                            @endcan
                            @can('all-fdr')
                                <li class="side-nav-item {{ isActive('admin.fdr.all*') }}">
                                    <a href="{{ route('admin.fdr.all') }}"><i
                                            data-lucide="user-check"></i><span>{{ __('All FDR') }}</span></a>
                                </li>
                            @endcan
                            @canany(['fdr-plan-list', 'fdr-plan-create', 'fdr-plan-edit'])
                                <li class="side-nav-item {{ isActive('admin.plan.fdr*') }}">
                                    <a href="{{ route('admin.plan.fdr.index') }}"><i
                                            data-lucide="airplay"></i><span>{{ __('FDR Plans') }}</span></a>
                                </li>
                            @endcanany
                        </ul>
                    </li>
            ...
            @canany(['manual-gateway-manage', 'deposit-list', 'deposit-action',
                ...
                @canany(['manage-portfolio', 'portfolio-create', 'portfolio-edit'])
                    <li class="side-nav-item {{ isActive('admin.portfolio.*') }}">
                        <a href="{{ route('admin.portfolio.index') }}"><i
                                data-lucide="medal"></i><span>{{ __('Portfolios') }}</span></a>
                    </li>
                @endcan
            ...
            ********************************************************* --}}
            @canany(['landing-page-manage', 'page-manage', 'footer-manage', 'navigation-manage', 'custom-css'])
                ...
                @can('landing-page-manage')
                    ...
                    <li
                        class="side-nav-item side-nav-dropdown  {{ isActive(['admin.page.section.section*', 'admin.footer-content']) }}">
                        <a href="javascript:void(0);" class="dropdown-link"><i
