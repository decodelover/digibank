    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="site-card">
                        ...
                        <div class="site-card-body">
                            ...
                            <div class="profile-text-data">
                                ...
                                <div class="value">{{ $currencySymbol . $loan->perInstallment() ?? 0 }}</div>
                            </div>
                            <div class="profile-text-data">
                            ...
                            <div class="profile-text-data">
                                ...
                                <div class="value">
                                    {{ $currencySymbol . $loan->transactions()->where('final_amount', '>', 0)->sum('paid_amount') ?? 0 }}
                                </div>
                            </div>
                            <div class="profile-text-data">
                            ...
                            <div class="profile-text-data">
                                ...
                                <div class="value">
                                    @include('backend.loan.include.__loan_status', [
                            ...
                            <div class="profile-text-data">
                                ...
                                <div class="value">
                                    <div class="site-badge success">
                                        {{ $currencySymbol . $loan->totalPayableAmount() - $loan->amount }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if (
                    $loan->status != App\Enums\LoanStatus::Reviewing &&
                        $loan->status != App\Enums\LoanStatus::Rejected &&
                        $loan->status != App\Enums\LoanStatus::Cancelled)
                    <div class="col-xl-12">
