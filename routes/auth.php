...
use App\Http\Controllers\Auth\EmailOtpVerifyController;
...
Route::middleware('auth')->group(function () {
    ...
    // Verify Email OTP
    Route::get('verify-email-otp', [EmailOtpVerifyController::class, 'index'])->name('email.otp.verify');
    Route::get('resend-email-otp', [EmailOtpVerifyController::class, 'resend'])->name('email.otp.resend');
    Route::post('verify-email-otp', [EmailOtpVerifyController::class, 'verify'])->name('email.otp.verify.post');
});
