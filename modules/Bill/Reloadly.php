...
class Reloadly
{
    ...
    public function __construct()
    {
        ...
        $this->client = Http::withOptions([
            'verify' => false,
        ])->baseUrl(config('reloadly.connections.live_or_sandbox_url'))->withToken($this->accessToken);
    ...
    public function getAccessToken()
    {
        ...
        $response = Http::withOptions([
            'verify' => false,
        ])->post('https://auth.reloadly.com/oauth/token', $params);
    ...
    public function getBiller($operator)
    {
